...
You must **complete at least 8 out of 10** challenges to earn the flag.
...
5. You need **8 out of 10** passing to earn the flag.
...
This will execute each mini-challenge's tests and report pass/fail. When 8 or more pass, the flag is printed.
...
Complete 8/10 challenges to reveal the flag.
